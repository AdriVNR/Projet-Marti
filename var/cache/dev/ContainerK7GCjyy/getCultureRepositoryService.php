...
// Returns the private 'App\Repository\CultureRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CultureRepository.php';

return $this->privates['App\\Repository\\CultureRepository'] = new \App\Repository\CultureRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
