...
// Returns the private 'App\Repository\ReportingRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ReportingRepository.php';

return $this->privates['App\\Repository\\ReportingRepository'] = new \App\Repository\ReportingRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
